...
API_URL = "https://hearteningly-ignorable-shaina.ngrok-free.dev/webhook/loan-default-risk-predictor"
...
real_estate_loans = st.number_input("Number of Real Estate Loans or Lines", min_value=0, value=1)
